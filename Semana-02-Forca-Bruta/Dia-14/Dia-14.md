# Day#14: Criação do primeiro Playbook de Resposta a Incidentes
...
`git add . && git commit -m "Finalizando Dia 14: Criação do primeiro Playbook de Resposta a Incidentes"`
