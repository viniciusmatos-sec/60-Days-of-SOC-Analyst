# Day#09: Investigação do alerta de Brute Force SSH no Wazuh (Triage)
...
`git add . && git commit -m "Finalizando Dia 09: Investigação do alerta de Brute Force SSH no Wazuh (Triage)"`
