# Day#04: Ingestão e análise de Windows Security Logs (Event IDs)
...
`git add . && git commit -m "Finalizando Dia 04: Ingestão e análise de Windows Security Logs (Event IDs)"`
