# Day#25: Investigação de IOCs com VirusTotal e AlienVault OTX
...
`git add . && git commit -m "Finalizando Dia 25: Investigação de IOCs com VirusTotal e AlienVault OTX"`
