# Day#26: Scripting em Python para automação de extração de IOCs
...
`git add . && git commit -m "Finalizando Dia 26: Scripting em Python para automação de extração de IOCs"`
